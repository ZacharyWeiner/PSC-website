    ...
    <div>
        ...
        <div class="relative bg-white">
            ...
            <div class="max-w-2xl mx-auto lg:max-w-none lg:mr-0 lg:ml-auto lg:w-1/2 lg:pl-10">
                ...
                <p class="text-left text-lg text-gray-500"><span class='text-indigo-600 font-bold' >Option 3: </span> Publish Them All Now!</p>
                ...
                <dl class="-mx-8 flex flex-wrap">
                    ...
                    <div class="flex flex-col px-8 pt-8">
                    <dt class="order-2 text-base font-medium text-gray-500">option3@relayx.io</dt>
