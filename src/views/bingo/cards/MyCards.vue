...
<Menu />
    ...
    <div class="w-full m-1 text-white text-left bg-gray-900 rounded-xl">
        <div class="flex"> 
            ...
            <div class='pr-4'> <button type="button" class="w-32 inline-flex text-xs px-4 py-1 border border-transparent font-medium rounded-full shadow-sm text-gray-900 bg-white hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 no-break"><div class='w-full mx-auto'>Find My Cards </div></button></div>
        </div>
